    ...
    stage('SonarQube Analysis') {
      steps {
        withSonarQubeEnv('MySonarQube') {
          sh '''#!/bin/bash
      /opt/sonar-scanner-6.2.0.4584-linux/bin/sonar-scanner         -Dsonar.projectKey=cmu-capstone         -Dsonar.sources=.         -Dsonar.python.version=3.x         -Dsonar.login=sqa_0cd94b0d8af364f302a0e8406809bfe482662f72
      '''
        }
